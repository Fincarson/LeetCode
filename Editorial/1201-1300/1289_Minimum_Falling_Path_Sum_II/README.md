...
[![Hard](../../../_Misc/Badges/Hard.svg)](https://leetcode.com/problems/minimum-falling-path-sum-ii/)  
...
| Problem | Difficulty |
|---|:---:|
| [Minimum Falling Path Sum](https://leetcode.com/problems/minimum-falling-path-sum/) | ![Medium](../../../_Misc/Badges/Med.svg) |
