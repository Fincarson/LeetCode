...
[![Easy](../../Miscellaneous/Badges/Easy.svg)](https://leetcode.com/problems/minimum-time-visiting-all-points/)  
`Array` `Math` `Geometry`
...
# Editorial - 1266. Minimum Time Visiting All Points
...
| Approach | Languages |
|---|---|
| Approach: Move Diagonally as Much as Possible | C++, Java, Python3 |
