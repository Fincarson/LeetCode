...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/move-pieces-to-obtain-a-string/)  
`Two Pointers` `String`
...
| [Swap Adjacent in LR String](https://leetcode.com/problems/swap-adjacent-in-lr-string/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
