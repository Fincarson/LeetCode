...
[![Easy](../../Miscellaneous/Badges/Easy.svg)](https://leetcode.com/problems/count-odd-numbers-in-an-interval-range/)  
`Math`
...
| Problem | Difficulty |
|---|:---:|
| [Check if Bitwise OR Has Trailing Zeros](https://leetcode.com/problems/check-if-bitwise-or-has-trailing-zeros/) | ![Easy](../../Miscellaneous/Badges/Easy.svg) |
