...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/most-stones-removed-with-same-row-or-column/)  
...
| Problem | Difficulty |
|---|:---:|
| [Minimum Moves to Get a Peaceful Board](https://leetcode.com/problems/minimum-moves-to-get-a-peaceful-board/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
