...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/koko-eating-bananas/)  
`Array` `Binary Search`
...
| Problem | Difficulty |
|---|:---:|
| [Minimize Max Distance to Gas Station](https://leetcode.com/problems/minimize-max-distance-to-gas-station/) | ![Hard](../../../_Misc/Badges/Hard.svg) |
...
| [Minimum Time to Repair Cars](https://leetcode.com/problems/minimum-time-to-repair-cars/) | ![Medium](../../../_Misc/Badges/Med.svg) |
