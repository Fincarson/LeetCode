...
[![Easy](../../../_Misc/Badges/Easy.svg)](https://leetcode.com/problems/buddy-strings/)  
`Hash Table` `String`
...
| [Check if One String Swap Can Make Strings Equal](https://leetcode.com/problems/check-if-one-string-swap-can-make-strings-equal/) | ![Easy](../../../_Misc/Badges/Easy.svg) |
