...
[![Easy](../../Miscellaneous/Badges/Easy.svg)](https://leetcode.com/problems/reformat-department-table/)  
`Database`

**Problem Link:** [LeetCode 1179 - Reformat Department Table](https://leetcode.com/problems/reformat-department-table/)
...
# Editorial - 1179. Reformat Department Table
...
| Approach | Languages |
|---|---|
| `GROUP BY` with a conditional statement in the aggregate function | MySQL |
| `LEFT JOIN` | MySQL |
