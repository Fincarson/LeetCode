...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/apples-oranges/)  
`Database`

**Problem Link:** [LeetCode 1445 - Apples & Oranges](https://leetcode.com/problems/apples-oranges/)
...
| Approach | Languages |
|---|---|
| Aliases or SELF JOIN | SQL |
| Create Two Separate Tables and Columns First | MySQL |
| Calculate With SUM(CASE WHEN) | MySQL |
