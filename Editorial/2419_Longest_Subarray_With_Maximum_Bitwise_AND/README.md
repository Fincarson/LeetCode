...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/longest-subarray-with-maximum-bitwise-and/)  
...
| Problem | Difficulty |
|---|:---:|
| [Number of Different Integers in a String](https://leetcode.com/problems/number-of-different-integers-in-a-string/) | ![Easy](../../Miscellaneous/Badges/Easy.svg) |
| [Remove Colored Pieces if Both Neighbors are the Same Color](https://leetcode.com/problems/remove-colored-pieces-if-both-neighbors-are-the-same-color/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
