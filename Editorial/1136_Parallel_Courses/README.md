...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/parallel-courses/)  
`Graph Theory` `Topological Sort`

**Problem Link:** [LeetCode 1136 - Parallel Courses](https://leetcode.com/problems/parallel-courses/)
...
| [Parallel Courses II](https://leetcode.com/problems/parallel-courses-ii/) | ![Hard](../../Miscellaneous/Badges/Hard.svg) |
| [Parallel Courses III](https://leetcode.com/problems/parallel-courses-iii/) | ![Hard](../../Miscellaneous/Badges/Hard.svg) |
...
# Editorial - 1136. Parallel Courses
...
| Approach | Languages |
|---|---|
| Breadth-First Search (Kahn's Algorithm) | C++, Java, Python3 |
| Depth-First Search: Check for Cycles + Find Longest Path | C++, Java, Python3 |
| Depth-First Search: Combine | C++, Java, Python3 |
