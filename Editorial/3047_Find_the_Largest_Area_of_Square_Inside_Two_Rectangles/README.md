...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/find-the-largest-area-of-square-inside-two-rectangles/)  
`Array` `Math` `Geometry`
...
| Problem | Difficulty |
|---|:---:|
| [Rectangle Area](https://leetcode.com/problems/rectangle-area/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
