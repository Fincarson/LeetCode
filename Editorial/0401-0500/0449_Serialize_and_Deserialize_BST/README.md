...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/serialize-and-deserialize-bst/)  
...
class Codec:
    ...
    def deserialize(self, data):
        ...
        data = [self.str_to_int(x) for x in data.split('ÃƒÂ§') if x]
        return helper()
```
