...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/matchsticks-to-square/)  
`Array` `Dynamic Programming` `Backtracking` `Bit Manipulation` `Bitmask`

**Problem Link:** [LeetCode 473 - Matchsticks to Square](https://leetcode.com/problems/matchsticks-to-square/)
...
# Editorial - 473. Matchsticks to Square
...
class Solution {
    ...
    // Possible side of our square depending on the total sum of all the matchsticks.Ã‚Â 
    public int possibleSquareSide;
