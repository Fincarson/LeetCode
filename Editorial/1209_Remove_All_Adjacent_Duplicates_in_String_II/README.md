...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string-ii/)  
`String` `Stack`
...
| Problem | Difficulty |
|---|:---:|
| [Remove All Adjacent Duplicates In String](https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string/) | ![Easy](../../Miscellaneous/Badges/Easy.svg) |
| [Replace Non-Coprime Numbers in Array](https://leetcode.com/problems/replace-non-coprime-numbers-in-array/) | ![Hard](../../Miscellaneous/Badges/Hard.svg) |
