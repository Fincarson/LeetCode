...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/open-the-lock/)  
`Array` `Hash Table` `String` `Breadth-First Search`

**Problem Link:** [LeetCode 752 - Open the Lock](https://leetcode.com/problems/open-the-lock/)
...
| Problem | Difficulty |
|---|:---:|
| [Reachable Nodes With Restrictions](https://leetcode.com/problems/reachable-nodes-with-restrictions/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
...
| Approach | Languages |
|---|---|
| Approach: Breadth-First Search | C++, Java, Python3 |
