...
[![Easy](../../../_Misc/Badges/Easy.svg)](https://leetcode.com/problems/minimum-number-of-operations-to-make-elements-in-array-distinct/)  
`Array` `Hash Table`
...
| Problem | Difficulty |
|---|:---:|
| [Minimum Increment to Make Array Unique](https://leetcode.com/problems/minimum-increment-to-make-array-unique/) | ![Medium](../../../_Misc/Badges/Med.svg) |
