...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/activity-participants/)  
`Database`
...
| NOT IN/EXISTSÃ¢â‚¬â€¹ | SQL |
| Using RANK() to Identify the Maximum and MinimumÃ¢â‚¬â€¹ | SQL |
...
## Approach 2: Using RANK() to Identify the Maximum and MinimumÃ¢â‚¬â€¹
