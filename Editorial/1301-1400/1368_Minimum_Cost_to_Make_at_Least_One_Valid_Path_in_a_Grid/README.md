...
[![Hard](../../../_Misc/Badges/Hard.svg)](https://leetcode.com/problems/minimum-cost-to-make-at-least-one-valid-path-in-a-grid/)  
...
| Problem | Difficulty |
|---|:---:|
| [Minimum Weighted Subgraph With the Required Paths](https://leetcode.com/problems/minimum-weighted-subgraph-with-the-required-paths/) | ![Hard](../../../_Misc/Badges/Hard.svg) |
| [Disconnect Path in a Binary Matrix by at Most One Flip](https://leetcode.com/problems/disconnect-path-in-a-binary-matrix-by-at-most-one-flip/) | ![Medium](../../../_Misc/Badges/Med.svg) |
