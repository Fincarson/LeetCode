...
[![Hard](../../../_Misc/Badges/Hard.svg)](https://leetcode.com/problems/minimum-distance-to-type-a-word-using-two-fingers/)  
...
| Problem | Difficulty |
|---|:---:|
| [Minimum Time to Type Word Using Special Typewriter](https://leetcode.com/problems/minimum-time-to-type-word-using-special-typewriter/) | ![Easy](../../../_Misc/Badges/Easy.svg) |
