...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/string-to-integer-atoi/)  
`String`
...
| Problem | Difficulty |
|---|:---:|
| [Reverse Integer](https://leetcode.com/problems/reverse-integer/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
| [Valid Number](https://leetcode.com/problems/valid-number/) | ![Hard](../../Miscellaneous/Badges/Hard.svg) |
| [Check if Numbers Are Ascending in a Sentence](https://leetcode.com/problems/check-if-numbers-are-ascending-in-a-sentence/) | ![Easy](../../Miscellaneous/Badges/Easy.svg) |
