...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/minimum-deletions-to-make-string-balanced/)  
...
| Problem | Difficulty |
|---|:---:|
| [Check if All A's Appears Before All B's](https://leetcode.com/problems/check-if-all-as-appears-before-all-bs/) | ![Easy](../../Miscellaneous/Badges/Easy.svg) |
