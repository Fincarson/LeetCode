...
[![Hard](../../../_Misc/Badges/Hard.svg)](https://leetcode.com/problems/minimum-operations-to-equalize-binary-string/)  
`Math` `String` `Breadth-First Search` `Union-Find` `Ordered Set`

**Problem Link:** [LeetCode 3666 - Minimum Operations to Equalize Binary String](https://leetcode.com/problems/minimum-operations-to-equalize-binary-string/)
...
- 1 <= s.length <= 10Ã¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹5
...
# Editorial - 3666. Minimum Operations to Equalize Binary String
