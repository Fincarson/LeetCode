...
[![Hard](../../Miscellaneous/Badges/Hard.svg)](https://leetcode.com/problems/average-salary-departments-vs-company/)  
`Database`
...
| Problem | Difficulty |
|---|:---:|
| [Countries You Can Safely Invest In](https://leetcode.com/problems/countries-you-can-safely-invest-in/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
