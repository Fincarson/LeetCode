...
[![Easy](../../Miscellaneous/Badges/Easy.svg)](https://leetcode.com/problems/design-hashset/)  
`Array` `Hash Table` `Linked List` `Design` `Hash Function`

**Problem Link:** [LeetCode 705 - Design HashSet](https://leetcode.com/problems/design-hashset/)
...
| Problem | Difficulty |
|---|:---:|
| [Design HashMap](https://leetcode.com/problems/design-hashmap/) | ![Easy](../../Miscellaneous/Badges/Easy.svg) |
...
| Approach | Languages |
|---|---|
| LinkedList as Bucket | Java, Python |
| Binary Search Tree (BST) as Bucket | Java, Python |
