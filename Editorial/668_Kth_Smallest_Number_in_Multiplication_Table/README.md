...
[![Hard](../../Miscellaneous/Badges/Hard.svg)](https://leetcode.com/problems/kth-smallest-number-in-multiplication-table/)  
`Math` `Binary Search`
...
| [Minimum Time to Eat All Grains](https://leetcode.com/problems/minimum-time-to-eat-all-grains/) | ![Hard](../../Miscellaneous/Badges/Hard.svg) |
| [Kth Smallest Amount With Single Denomination Combination](https://leetcode.com/problems/kth-smallest-amount-with-single-denomination-combination/) | ![Hard](../../Miscellaneous/Badges/Hard.svg) |
