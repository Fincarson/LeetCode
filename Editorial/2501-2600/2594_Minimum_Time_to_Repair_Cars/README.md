...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/minimum-time-to-repair-cars/)  
`Array` `Binary Search`
...
It can be proved that the cars cannot be repaired in less than 16 minutes.Ã¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹
```
