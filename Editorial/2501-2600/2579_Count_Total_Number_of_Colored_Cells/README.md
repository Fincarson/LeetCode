...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/count-total-number-of-colored-cells/)  
`Math`
...
| Problem | Difficulty |
|---|:---:|
| [Minimum Cuts to Divide a Circle](https://leetcode.com/problems/minimum-cuts-to-divide-a-circle/) | ![Easy](../../../_Misc/Badges/Easy.svg) |
