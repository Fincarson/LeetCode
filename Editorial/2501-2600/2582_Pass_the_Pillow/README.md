...
[![Easy](../../../_Misc/Badges/Easy.svg)](https://leetcode.com/problems/pass-the-pillow/)  
`Math` `Simulation`
...
| Problem | Difficulty |
|---|:---:|
| [Find the Student that Will Replace the Chalk](https://leetcode.com/problems/find-the-student-that-will-replace-the-chalk/) | ![Medium](../../../_Misc/Badges/Med.svg) |
