...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/range-addition/)  
`Array` `Prefix Sum`
...
| Problem | Difficulty |
|---|:---:|
| [Range Addition II](https://leetcode.com/problems/range-addition-ii/) | ![Easy](../../Miscellaneous/Badges/Easy.svg) |
