...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/find-polygon-with-the-largest-perimeter/)  
`Array` `Greedy` `Sorting` `Prefix Sum`

**Problem Link:** [LeetCode 2971 - Find Polygon With the Largest Perimeter](https://leetcode.com/problems/find-polygon-with-the-largest-perimeter/)
...
# Editorial - 2971. Find Polygon With the Largest Perimeter
