...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/minimum-penalty-for-a-shop/)  
`String` `Prefix Sum`
...
| Problem | Difficulty |
|---|:---:|
| [Grid Game](https://leetcode.com/problems/grid-game/) | ![Medium](../../../_Misc/Badges/Med.svg) |
