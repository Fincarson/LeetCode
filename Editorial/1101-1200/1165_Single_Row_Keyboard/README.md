...
[![Easy](../../../_Misc/Badges/Easy.svg)](https://leetcode.com/problems/single-row-keyboard/)  
`Hash Table` `String`
...
| Problem | Difficulty |
|---|:---:|
| [Total Distance to Type a String Using One Finger](https://leetcode.com/problems/total-distance-to-type-a-string-using-one-finger/) | ![Medium](../../../_Misc/Badges/Med.svg) |
