...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/rotate-image/)  
`Array` `Math` `Matrix`
...
| Problem | Difficulty |
|---|:---:|
| [Determine Whether Matrix Can Be Obtained By Rotation](https://leetcode.com/problems/determine-whether-matrix-can-be-obtained-by-rotation/) | ![Easy](../../../_Misc/Badges/Easy.svg) |
