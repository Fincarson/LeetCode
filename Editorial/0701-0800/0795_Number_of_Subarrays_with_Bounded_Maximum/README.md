...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/number-of-subarrays-with-bounded-maximum/)  
`Array` `Two Pointers`
...
| Problem | Difficulty |
|---|:---:|
| [Count Subarrays With Median K](https://leetcode.com/problems/count-subarrays-with-median-k/) | ![Hard](../../../_Misc/Badges/Hard.svg) |
