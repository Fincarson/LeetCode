...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/count-number-of-homogenous-substrings/)  
`Math` `String`
...
| [Number of Substrings With Only 1s](https://leetcode.com/problems/number-of-substrings-with-only-1s/) | ![Medium](../../../_Misc/Badges/Med.svg) |
