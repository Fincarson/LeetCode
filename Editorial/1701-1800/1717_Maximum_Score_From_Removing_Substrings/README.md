...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/maximum-score-from-removing-substrings/)  
`String` `Stack` `Greedy`
...
| Problem | Difficulty |
|---|:---:|
| [Count Words Obtained After Adding a Letter](https://leetcode.com/problems/count-words-obtained-after-adding-a-letter/) | ![Medium](../../../_Misc/Badges/Med.svg) |
