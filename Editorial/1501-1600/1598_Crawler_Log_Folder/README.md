...
[![Easy](../../../_Misc/Badges/Easy.svg)](https://leetcode.com/problems/crawler-log-folder/)  
`Array` `String` `Stack`
...
| Problem | Difficulty |
|---|:---:|
| [Baseball Game](https://leetcode.com/problems/baseball-game/) | ![Easy](../../../_Misc/Badges/Easy.svg) |
