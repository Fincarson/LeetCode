...
[![Hard](../../Miscellaneous/Badges/Hard.svg)](https://leetcode.com/problems/count-the-number-of-arrays-with-k-matching-adjacent-elements/)  
`Math` `Combinatorics`
...
| Problem | Difficulty |
|---|:---:|
| [Count Good Numbers](https://leetcode.com/problems/count-good-numbers/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
