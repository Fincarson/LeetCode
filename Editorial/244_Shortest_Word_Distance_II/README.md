...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/shortest-word-distance-ii/)  
`Array` `Hash Table` `Two Pointers` `String` `Design`

**Problem Link:** [LeetCode 244 - Shortest Word Distance II](https://leetcode.com/problems/shortest-word-distance-ii/)
...
| [Shortest Word Distance III](https://leetcode.com/problems/shortest-word-distance-iii/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
...
# Editorial - 244. Shortest Word Distance II
...
| Approach | Languages |
|---|---|
| Using Preprocessed Sorted Indices | Java, Python3 |
