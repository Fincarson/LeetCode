...
[![Hard](../../../_Misc/Badges/Hard.svg)](https://leetcode.com/problems/painting-a-grid-with-three-different-colors/)  
`Dynamic Programming`
...
| Problem | Difficulty |
|---|:---:|
| [Number of Ways to Paint N Ãƒâ€” 3 Grid](https://leetcode.com/problems/number-of-ways-to-paint-n-3-grid/) | ![Hard](../../../_Misc/Badges/Hard.svg) |
