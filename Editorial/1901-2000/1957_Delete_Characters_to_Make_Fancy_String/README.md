...
[![Easy](../../../_Misc/Badges/Easy.svg)](https://leetcode.com/problems/delete-characters-to-make-fancy-string/)  
`String`
...
| Problem | Difficulty |
|---|:---:|
| [Find Maximum Removals From Source String](https://leetcode.com/problems/find-maximum-removals-from-source-string/) | ![Medium](../../../_Misc/Badges/Med.svg) |
