...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/count-salary-categories/)  
`Database`
...
| Problem | Difficulty |
|---|:---:|
| [Create a Session Bar Chart](https://leetcode.com/problems/create-a-session-bar-chart/) | ![Easy](../../../_Misc/Badges/Easy.svg) |
