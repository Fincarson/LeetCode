...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/count-good-numbers/)  
`Math` `Recursion`
...
| Problem | Difficulty |
|---|:---:|
| [Count the Number of Arrays with K Matching Adjacent Elements](https://leetcode.com/problems/count-the-number-of-arrays-with-k-matching-adjacent-elements/) | ![Hard](../../../_Misc/Badges/Hard.svg) |
