...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/cyclically-rotating-a-grid/)  
...
You are given an m x n integer matrix gridÃ¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹, where m and n are both even integers, and an integer k.
