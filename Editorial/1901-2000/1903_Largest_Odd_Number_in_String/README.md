...
[![Easy](../../../_Misc/Badges/Easy.svg)](https://leetcode.com/problems/largest-odd-number-in-string/)  
`Math` `String` `Greedy`
...
| Problem | Difficulty |
|---|:---:|
| [Largest 3-Same-Digit Number in String](https://leetcode.com/problems/largest-3-same-digit-number-in-string/) | ![Easy](../../../_Misc/Badges/Easy.svg) |
