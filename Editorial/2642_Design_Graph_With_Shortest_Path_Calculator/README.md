...
[![Hard](../../Miscellaneous/Badges/Hard.svg)](https://leetcode.com/problems/design-graph-with-shortest-path-calculator/)  
...
| Problem | Difficulty |
|---|:---:|
| [Number of Restricted Paths From First to Last Node](https://leetcode.com/problems/number-of-restricted-paths-from-first-to-last-node/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
| [Closest Node to Path in Tree](https://leetcode.com/problems/closest-node-to-path-in-tree/) | ![Hard](../../Miscellaneous/Badges/Hard.svg) |
