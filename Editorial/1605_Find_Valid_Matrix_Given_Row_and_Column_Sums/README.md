...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/find-valid-matrix-given-row-and-column-sums/)  
`Array` `Greedy` `Matrix`
...
| Problem | Difficulty |
|---|:---:|
| [Reconstruct a 2-Row Binary Matrix](https://leetcode.com/problems/reconstruct-a-2-row-binary-matrix/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
