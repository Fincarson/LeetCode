...
[![Easy](../../../_Misc/Badges/Easy.svg)](https://leetcode.com/problems/count-operations-to-obtain-zero/)  
`Math` `Simulation`
...
| Problem | Difficulty |
|---|:---:|
| [Number of Steps to Reduce a Number to Zero](https://leetcode.com/problems/number-of-steps-to-reduce-a-number-to-zero/) | ![Easy](../../../_Misc/Badges/Easy.svg) |
