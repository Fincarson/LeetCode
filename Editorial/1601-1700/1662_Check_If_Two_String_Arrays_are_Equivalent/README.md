...
[![Easy](../../../_Misc/Badges/Easy.svg)](https://leetcode.com/problems/check-if-two-string-arrays-are-equivalent/)  
`Array` `String`
...
| Problem | Difficulty |
|---|:---:|
| [Check if an Original String Exists Given Two Encoded Strings](https://leetcode.com/problems/check-if-an-original-string-exists-given-two-encoded-strings/) | ![Hard](../../../_Misc/Badges/Hard.svg) |
