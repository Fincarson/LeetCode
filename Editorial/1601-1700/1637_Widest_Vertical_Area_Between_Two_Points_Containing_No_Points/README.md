...
[![Easy](../../../_Misc/Badges/Easy.svg)](https://leetcode.com/problems/widest-vertical-area-between-two-points-containing-no-points/)  
`Array` `Sorting`
...
| Problem | Difficulty |
|---|:---:|
| [Maximum Gap](https://leetcode.com/problems/maximum-gap/) | ![Medium](../../../_Misc/Badges/Med.svg) |
