...
[![Hard](../../../_Misc/Badges/Hard.svg)](https://leetcode.com/problems/minimum-initial-energy-to-finish-tasks/)  
...
func minimumEffort(tasks [][]int) int {
	...
	for _, task := range tasks {
		if remain > task[1] {
			// Ã¤Â¸ÂÃ©Å“â‚¬Ã¨Â¦ÂÃ¥Â¢Å¾Ã¥Å Â Ã¨Æ’Â½Ã©â€¡Â
		} else {
			ans += task[1] - remain
		}
