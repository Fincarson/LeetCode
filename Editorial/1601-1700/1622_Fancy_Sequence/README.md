...
[![Hard](../../../_Misc/Badges/Hard.svg)](https://leetcode.com/problems/fancy-sequence/)  
...
// Ã¥Ë†â€ºÃ¥Â»Âº Fancy Ã¥Â¯Â¹Ã¨Â±Â¡
Fancy* fancyCreate() {
    Fancy* obj = (Fancy*)malloc(sizeof(Fancy));
    obj->v = vectorCreate();
    obj->a = vectorCreate();
    obj->b = vectorCreate();
    // Ã¥Ë†ÂÃ¥Â§â€¹Ã¥Å’â€“ a[0] = 1, b[0] = 0
...
// Ã¨Å½Â·Ã¥Ââ€“Ã§Â´Â¢Ã¥Â¼â€¢Ã¥Â¤â€žÃ§Å¡â€žÃ¥â‚¬Â¼
...
// fast exponentiationÃ¯Â¼Ë†Ã¨Â¿â€Ã¥â€ºÅ¾bigintÃ¯Â¼â€°
...
// multiplicative inverseÃ¯Â¼Ë†Ã¨Â¿â€Ã¥â€ºÅ¾bigintÃ¯Â¼â€°
...
class Fancy {
    ...
    // fast exponentiationÃ¯Â¼Ë†Ã¤Â½Â¿Ã§â€Â¨bigintÃ¯Â¼â€°
    ...
    // multiplicative inverseÃ¯Â¼Ë†Ã¤Â½Â¿Ã§â€Â¨Ã¨Â´Â¹Ã©Â©Â¬Ã¥Â°ÂÃ¥Â®Å¡Ã§Ââ€ Ã¯Â¼â€°
