...
[![Easy](../../../_Misc/Badges/Easy.svg)](https://leetcode.com/problems/number-of-students-unable-to-eat-lunch/)  
...
You are given two integer arrays students and sandwiches where sandwiches[i] is the type of the iÃ¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹th sandwich in the stack (i = 0 is the top of the stack) and students[j] is the preference of the jÃ¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹Ã¢â‚¬â€¹th student in the initial queue (j = 0 is the front of the queue). Return the number of students that are unable to eat.
...
| Problem | Difficulty |
|---|:---:|
| [Time Needed to Buy Tickets](https://leetcode.com/problems/time-needed-to-buy-tickets/) | ![Easy](../../../_Misc/Badges/Easy.svg) |
