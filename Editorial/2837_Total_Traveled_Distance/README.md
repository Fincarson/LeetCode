...
[![Easy](../../Miscellaneous/Badges/Easy.svg)](https://leetcode.com/problems/total-traveled-distance/)  
`Database`

**Problem Link:** [LeetCode 2837 - Total Traveled Distance](https://leetcode.com/problems/total-traveled-distance/)
...
# Editorial - 2837. Total Traveled Distance
...
| Approach | Languages |
|---|---|
| Approach: Using left merge and fillna() | Pandas |
