...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/design-log-storage-system/)  
`Hash Table` `String` `Design` `Ordered Set`

**Problem Link:** [LeetCode 635 - Design Log Storage System](https://leetcode.com/problems/design-log-storage-system/)
...
# Editorial - 635. Design Log Storage System
...
| Approach | Languages |
|---|---|
| Approach #1 Converting timestamp into a number [Accepted] | Java |
| Approach #2 Better Retrieval [Accepted] | Java |
