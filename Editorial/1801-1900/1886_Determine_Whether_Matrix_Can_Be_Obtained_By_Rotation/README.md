...
[![Easy](../../../_Misc/Badges/Easy.svg)](https://leetcode.com/problems/determine-whether-matrix-can-be-obtained-by-rotation/)  
`Array` `Matrix`
...
| Problem | Difficulty |
|---|:---:|
| [Rotate Image](https://leetcode.com/problems/rotate-image/) | ![Medium](../../../_Misc/Badges/Med.svg) |
