...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/biggest-window-between-visits/)  
`Database`
...
| Problem | Difficulty |
|---|:---:|
| [Users With Two Purchases Within Seven Days](https://leetcode.com/problems/users-with-two-purchases-within-seven-days/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
