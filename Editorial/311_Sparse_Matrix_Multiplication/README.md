...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/sparse-matrix-multiplication/)  
`Array` `Hash Table` `Matrix`

**Problem Link:** [LeetCode 311 - Sparse Matrix Multiplication](https://leetcode.com/problems/sparse-matrix-multiplication/)
...
# Editorial - 311. Sparse Matrix Multiplication
...
| Approach | Languages |
|---|---|
| Naive Iteration | C++, Java, JavaScript, Python3 |
| List of Lists | C++, Java, JavaScript, Python3 |
| Yale Format | C++, Java, JavaScript, Python3 |
