...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/delete-the-middle-node-of-a-linked-list/)  
...
The middle node of a linked list of size n is the Ã¢Å’Å n / 2Ã¢Å’â€¹th node from the start using 0-based indexing, where Ã¢Å’Å xÃ¢Å’â€¹ denotes the largest integer less than or equal to x.
...
| Problem | Difficulty |
|---|:---:|
| [Remove Nth Node From End of List](https://leetcode.com/problems/remove-nth-node-from-end-of-list/) | ![Medium](../../../_Misc/Badges/Med.svg) |
