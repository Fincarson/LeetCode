...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/construct-the-lexicographically-largest-valid-sequence/)  
`Array` `Backtracking`
...
| Problem | Difficulty |
|---|:---:|
| [The Number of Beautiful Subsets](https://leetcode.com/problems/the-number-of-beautiful-subsets/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
| [Find the Lexicographically Largest String From the Box I](https://leetcode.com/problems/find-the-lexicographically-largest-string-from-the-box-i/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
