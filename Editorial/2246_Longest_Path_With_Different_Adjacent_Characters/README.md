...
[![Hard](../../Miscellaneous/Badges/Hard.svg)](https://leetcode.com/problems/longest-path-with-different-adjacent-characters/)  
...
| Problem | Difficulty |
|---|:---:|
| [Diameter of Binary Tree](https://leetcode.com/problems/diameter-of-binary-tree/) | ![Easy](../../Miscellaneous/Badges/Easy.svg) |
| [Longest Univalue Path](https://leetcode.com/problems/longest-univalue-path/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
| [Choose Edges to Maximize Score in a Tree](https://leetcode.com/problems/choose-edges-to-maximize-score-in-a-tree/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
