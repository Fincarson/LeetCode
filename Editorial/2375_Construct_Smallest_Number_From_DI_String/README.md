...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/construct-smallest-number-from-di-string/)  
...
| Problem | Difficulty |
|---|:---:|
| [DI String Match](https://leetcode.com/problems/di-string-match/) | ![Easy](../../Miscellaneous/Badges/Easy.svg) |
