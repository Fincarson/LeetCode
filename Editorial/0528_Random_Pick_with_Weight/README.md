...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/random-pick-with-weight/)  
`Array` `Math` `Binary Search` `Prefix Sum` `Randomized`

**Problem Link:** [LeetCode 528 - Random Pick with Weight](https://leetcode.com/problems/random-pick-with-weight/)
...
| Problem | Difficulty |
|---|:---:|
| [Random Pick Index](https://leetcode.com/problems/random-pick-index/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
| [Random Pick with Blacklist](https://leetcode.com/problems/random-pick-with-blacklist/) | ![Hard](../../Miscellaneous/Badges/Hard.svg) |
| [Random Point in Non-overlapping Rectangles](https://leetcode.com/problems/random-point-in-non-overlapping-rectangles/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
...
# Editorial - 528. Random Pick with Weight
...
| Approach | Languages |
|---|---|
| Prefix Sums with Linear Search | C++, Java, Python3 |
| Prefix Sums with Binary Search | C++, Java, Python3 |
