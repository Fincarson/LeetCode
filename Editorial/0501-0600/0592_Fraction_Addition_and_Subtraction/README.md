...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/fraction-addition-and-subtraction/)  
...
- Each fraction (input and output) has the format Ã‚Â±numerator/denominator. If the first input fraction or the output is positive, then '+' will be omitted.
...
| Problem | Difficulty |
|---|:---:|
| [Solve the Equation](https://leetcode.com/problems/solve-the-equation/) | ![Medium](../../../_Misc/Badges/Med.svg) |
