...
[![Easy](../../../_Misc/Badges/Easy.svg)](https://leetcode.com/problems/friend-requests-i-overall-acceptance-rate/)  
`Database`
...
- It is possible that a sender sends multiple requests to the same receiver, and a request could be accepted more than once. In this case, the Ã¢â‚¬ËœduplicatedÃ¢â‚¬â„¢ requests or acceptances are only counted once.
