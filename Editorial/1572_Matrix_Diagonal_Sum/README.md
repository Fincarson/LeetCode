...
[![Easy](../../Miscellaneous/Badges/Easy.svg)](https://leetcode.com/problems/matrix-diagonal-sum/)  
`Array` `Matrix`
...
| Problem | Difficulty |
|---|:---:|
| [Check if Every Row and Column Contains All Numbers](https://leetcode.com/problems/check-if-every-row-and-column-contains-all-numbers/) | ![Easy](../../Miscellaneous/Badges/Easy.svg) |
| [Check if Matrix Is X-Matrix](https://leetcode.com/problems/check-if-matrix-is-x-matrix/) | ![Easy](../../Miscellaneous/Badges/Easy.svg) |
