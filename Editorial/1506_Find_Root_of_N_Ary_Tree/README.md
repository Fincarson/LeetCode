...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/find-root-of-n-ary-tree/)  
...
| Problem | Difficulty |
|---|:---:|
| [Move Sub-Tree of N-Ary Tree](https://leetcode.com/problems/move-sub-tree-of-n-ary-tree/) | ![Hard](../../Miscellaneous/Badges/Hard.svg) |
...
| Approach | Languages |
|---|---|
| Déjà-Vu (_O(N)_ Space) | Java, Python3 |
