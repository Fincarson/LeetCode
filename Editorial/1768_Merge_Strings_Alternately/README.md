...
[![Easy](../../Miscellaneous/Badges/Easy.svg)](https://leetcode.com/problems/merge-strings-alternately/)  
`Two Pointers` `String`
...
| [Minimum Additions to Make Valid String](https://leetcode.com/problems/minimum-additions-to-make-valid-string/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
