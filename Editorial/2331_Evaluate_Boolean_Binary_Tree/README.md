...
[![Easy](../../Miscellaneous/Badges/Easy.svg)](https://leetcode.com/problems/evaluate-boolean-binary-tree/)  
...
| Problem | Difficulty |
|---|:---:|
| [Check If Two Expression Trees are Equivalent](https://leetcode.com/problems/check-if-two-expression-trees-are-equivalent/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
| [Design an Expression Tree With Evaluate Function](https://leetcode.com/problems/design-an-expression-tree-with-evaluate-function/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
| [Minimum Flips in Binary Tree to Get Result](https://leetcode.com/problems/minimum-flips-in-binary-tree-to-get-result/) | ![Hard](../../Miscellaneous/Badges/Hard.svg) |
