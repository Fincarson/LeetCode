...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/where-will-the-ball-fall/)  
`Array` `Matrix` `Simulation`

**Problem Link:** [LeetCode 1706 - Where Will the Ball Fall](https://leetcode.com/problems/where-will-the-ball-fall/)
...
# Editorial - 1706. Where Will the Ball Fall
...
| Dynamic Programming Approach | C++, Java |
| Iterative Approach, Simulation | C++, Java |
