...
[![Hard](../../Miscellaneous/Badges/Hard.svg)](https://leetcode.com/problems/count-vowels-permutation/)  
`Dynamic Programming`
...
| Problem | Difficulty |
|---|:---:|
| [Number of Strings Which Can Be Rearranged to Contain Substring](https://leetcode.com/problems/number-of-strings-which-can-be-rearranged-to-contain-substring/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
