...
[![Easy](../../../_Misc/Badges/Easy.svg)](https://leetcode.com/problems/running-sum-of-1d-array/)  
`Array` `Prefix Sum`
...
Given an array nums. We define a running sum of an array as runningSum[i] = sum(nums[0]Ã¢â‚¬Â¦nums[i]).
