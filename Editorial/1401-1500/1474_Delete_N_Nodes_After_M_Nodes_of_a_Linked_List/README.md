...
[![Easy](../../../_Misc/Badges/Easy.svg)](https://leetcode.com/problems/delete-n-nodes-after-m-nodes-of-a-linked-list/)  
`Linked List`
...
| [Remove Zero Sum Consecutive Nodes from Linked List](https://leetcode.com/problems/remove-zero-sum-consecutive-nodes-from-linked-list/) | ![Medium](../../../_Misc/Badges/Med.svg) |
