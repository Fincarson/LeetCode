...
[![Hard](../../Miscellaneous/Badges/Hard.svg)](https://leetcode.com/problems/remove-max-number-of-edges-to-keep-graph-fully-traversable/)  
`Union-Find` `Graph Theory`

**Problem Link:** [LeetCode 1579 - Remove Max Number of Edges to Keep Graph Fully Traversable](https://leetcode.com/problems/remove-max-number-of-edges-to-keep-graph-fully-traversable/)
...
# Editorial - 1579. Remove Max Number of Edges to Keep Graph Fully Traversable
