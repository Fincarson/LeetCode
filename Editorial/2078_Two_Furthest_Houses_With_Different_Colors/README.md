...
[![Easy](../../Miscellaneous/Badges/Easy.svg)](https://leetcode.com/problems/two-furthest-houses-with-different-colors/)  
`Array` `Greedy`
...
| Problem | Difficulty |
|---|:---:|
| [Replace Elements with Greatest Element on Right Side](https://leetcode.com/problems/replace-elements-with-greatest-element-on-right-side/) | ![Easy](../../Miscellaneous/Badges/Easy.svg) |
| [Maximum Distance Between a Pair of Values](https://leetcode.com/problems/maximum-distance-between-a-pair-of-values/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
