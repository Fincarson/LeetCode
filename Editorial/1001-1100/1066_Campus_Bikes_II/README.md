...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/campus-bikes-ii/)  
...
| Problem | Difficulty |
|---|:---:|
| [Campus Bikes](https://leetcode.com/problems/campus-bikes/) | ![Medium](../../../_Misc/Badges/Med.svg) |
...
public:
    ...
    // Count the number of ones using Brian KernighanÃ¢â‚¬â„¢s Algorithm
