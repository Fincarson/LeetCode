...
[![Hard](../../Miscellaneous/Badges/Hard.svg)](https://leetcode.com/problems/popularity-percentage/)  
`Database`

**Problem Link:** [LeetCode 2720 - Popularity Percentage](https://leetcode.com/problems/popularity-percentage/)
...
# Editorial - 2720. Popularity Percentage
...
| Approach | Languages |
|---|---|
| Approach: Bidirectional Friendship Expansion and Aggregation | Pandas |
