...
[![Easy](../../Miscellaneous/Badges/Easy.svg)](https://leetcode.com/problems/design-compressed-string-iterator/)  
`Array` `String` `Design` `Iterator`

**Problem Link:** [LeetCode 604 - Design Compressed String Iterator](https://leetcode.com/problems/design-compressed-string-iterator/)
...
# Editorial - 604. Design Compressed String Iterator
...
| Approach | Languages |
|---|---|
| Approach #1 Uncompressing the String [Time Limit Exceeded] | Java |
| Approach #2  Pre-Computation [Accepted] | Java |
| Approach #3  Demand-Computation [Accepted] | Java |
