...
[![Hard](../../Miscellaneous/Badges/Hard.svg)](https://leetcode.com/problems/erect-the-fence/)  
`Array` `Math` `Geometry`
...
| Problem | Difficulty |
|---|:---:|
| [Erect the Fence II](https://leetcode.com/problems/erect-the-fence-ii/) | ![Hard](../../Miscellaneous/Badges/Hard.svg) |
