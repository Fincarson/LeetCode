...
[![Medium](../../../_Misc/Badges/Med.svg)](https://leetcode.com/problems/minimum-average-difference/)  
`Array` `Prefix Sum`
...
| Problem | Difficulty |
|---|:---:|
| [Split Array With Same Average](https://leetcode.com/problems/split-array-with-same-average/) | ![Hard](../../../_Misc/Badges/Hard.svg) |
