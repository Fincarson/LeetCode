...
[![Medium](../../Miscellaneous/Badges/Med.svg)](https://leetcode.com/problems/split-array-into-fibonacci-sequence/)  
`String` `Backtracking`
...
| Problem | Difficulty |
|---|:---:|
| [Additive Number](https://leetcode.com/problems/additive-number/) | ![Medium](../../Miscellaneous/Badges/Med.svg) |
